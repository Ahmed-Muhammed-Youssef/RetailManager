...
namespace DataManager.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new RetailUser { UserName = Input.Email, Email = Input.Email, FullName = Input.FullName };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Please confirm your account by <html><a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a><html>.");
